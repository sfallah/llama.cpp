...
ggml_tensor * clip_graph_deepseekocr::build_clip(ggml_tensor * sam_out) {
    ggml_tensor * inp;
    ...
    if (tgt_size != src_size) {
        ...
        new_pos_embd =
            ggml_interpolate(ctx0, old_pos_embd, tgt_size, tgt_size, new_pos_embd->ne[0], 1, GGML_SCALE_MODE_BICUBIC);
